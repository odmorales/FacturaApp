...
namespace PruebaTecnicaApp.Service
{
    public class JwtService
    {
        ...
        public LoginViewModel GenerarToken(Usuario userLogin)
        {
            ...
            var userResponse = new LoginViewModel() { UsuNombre = userLogin.UsuNombre, Rol = userLogin.Rol };
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                Subject = new ClaimsIdentity(new[] { 
                    new Claim("UsuNombre", userLogin.UsuNombre!.ToString()),
